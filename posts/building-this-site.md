...
Leptos is a reactive web framework for Rust that compiles to WebAssembly. It is designed to provide the reactive, component-based architecture of popular frontend frameworks, but with the performance and safety of Rust. Overall, I found Leptos to be fairly straightforward to learn and use, and I was able to build my site according to my tastes pretty quickly. Admittedly, my site is a fairly simple design and has limited functionality, but it
