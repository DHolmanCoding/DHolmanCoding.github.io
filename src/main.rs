    ...
    view! {
        <footer>
            <div class="contact-links">
                <a href="https://github.com/DHolmanCoding" target="_blank" class="contact-link">
                ...
                <a href="https://www.linkedin.com/in/douglas-holman/" target="_blank" class="contact-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
